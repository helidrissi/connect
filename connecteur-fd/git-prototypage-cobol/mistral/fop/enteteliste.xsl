...
<fo:block-container font-size="7pt" left="0mm" width="195mm" line-height="6mm" height="15mm" text-align="left" top="0mm" position="absolute">
  <fo:block font-style="italic" font-weight="bold"><xsl:value-of select="piedliste-l"/> &#160;&#160; <xsl:value-of select="nomsel"/> </fo:block>
</fo:block-container>
...
<xsl:variable name="titcrit">
     ...
     <fo:table table-layout="fixed" border-style="solid 0.3mm" border-width="0.0mm" left="0mm" width="195mm" position="absolute">
      ...
      <fo:table-header>
        <fo:table-row line-height="10pt" background-color="{$colorbleu}" color="black" text-align="left" font-weight="bold">
...
<xsl:template match="critere-l">
      <fo:table-row line-height="10pt" keep-with-previous="always">
