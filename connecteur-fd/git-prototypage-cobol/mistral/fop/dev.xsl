	  ...
	  <fo:table-header>
	    <fo:table-row line-height="14pt" background-color="{$colorgris}" color="black" font-weight="bold">
	      <fo:table-cell color="white" background-color="white"> <fo:block> . </fo:block> </fo:table-cell>
 	      ...
 	      <fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> Nombre de décimales du Cours </fo:block> </fo:table-cell>
              ...
              <fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> Valeur Cours</fo:block> <fo:block>  Précédent  </fo:block> </fo:table-cell>                
              <fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> Date Cours</fo:block> <fo:block>  Précédent </fo:block> </fo:table-cell>                
	    </fo:table-row>
 	  </fo:table-header>
	  <fo:table-footer>
	  </fo:table-footer>
