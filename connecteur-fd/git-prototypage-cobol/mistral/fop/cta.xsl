...
<fo:region-after extent="10mm"/>
        ...
        <fo:static-content flow-name="xsl-region-before" font-size="9pt">
				...
				<fo:flow flow-name="xsl-region-body" font-family="{$fontfamily}" font-size="9pt">		<!--Taille de la police pour l'espace de travail-->
					<fo:table table-layout="fixed" border-style="solid 0.3mm" border-width="0.0mm" left="195mm" width="110mm" position="absolute">		<!--Taille du tableau-->
						...
						<fo:table-column padding-top="-0.15mm" padding-left="-0.15mm" padding-right="-0.15mm" border="solid 0.3mm" column-width="50mm"/>
						...
						<fo:table-header>
							<fo:table-row line-height="20pt" background-color="{$colorbleu}" color="black" font-weight="bold">
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> <xsl:value-of select="/mistral/enteteliste/zontitdeb"/> </fo:block> </fo:table-cell>
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> <xsl:value-of select="/mistral/enteteliste/zontitpid"/> </fo:block> </fo:table-cell>
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> <xsl:value-of select="/mistral/enteteliste/zontitide"/> </fo:block> </fo:table-cell>
								...
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> <xsl:value-of select="/mistral/enteteliste/zontitlog"/> </fo:block> </fo:table-cell>
							</fo:table-row>
						</fo:table-header>
						<fo:table-footer>
						</fo:table-footer>
						<fo:table-body>
							<fo:table-row line-height="10pt">
								<fo:table-cell number-columns-spanned="6"> <fo:block color="white"> . </fo:block> </fo:table-cell>
							</fo:table-row>
	...
	<xsl:template match="/mistral/cta">
		<fo:table-row line-height="15pt">
			<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="center"> <fo:block> <xsl:value-of select="deb"/> </fo:block> </fo:table-cell>
			<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="center">   <fo:block> <xsl:value-of select="pid"/> </fo:block> </fo:table-cell>
			<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="center">   <fo:block> <xsl:value-of select="ide"/> </fo:block> </fo:table-cell>
			<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="left">   <fo:block> <xsl:value-of select="nom"/> </fo:block> </fo:table-cell>
			...
			<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="center"> <fo:block> <xsl:value-of select="log"/> </fo:block> </fo:table-cell>
		</fo:table-row>
	</xsl:template>
