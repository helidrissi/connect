...
<!--fo:region-body margin-top="25mm" margin-bottom="150mm"/-->
...
<fo:region-after extent="10mm"/>
        ...
        <fo:static-content flow-name="xsl-region-before" font-size="9pt">				
				...
				<fo:flow flow-name="xsl-region-body" font-size="9pt">		<!--Taille de la police pour l'espace de travail-->
					<fo:table table-layout="fixed" border-style="solid 0.3mm" border-width="0.0mm" width="165mm">		<!--Taille du tableau-->
					  <fo:table-column background-color="white"  color="white" column-width="25mm" />
						...
						<fo:table-header>
							<fo:table-row line-height="20pt" background-color="{$colorgris}" color="black" font-weight="bold">
							  <fo:table-cell color="white" background-color="white"> <fo:block> . </fo:block> </fo:table-cell>
								...
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> Libellé </fo:block> </fo:table-cell>
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> Code / Norme ISO </fo:block> </fo:table-cell>
								<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" border="solid 0.3mm" text-align="center"> <fo:block> Code Pays C.E.E. </fo:block> </fo:table-cell>
							</fo:table-row>
						</fo:table-header>
						<fo:table-footer>
						</fo:table-footer>
	...
	<xsl:template match="/mistral/pay">
		<fo:table-row line-height="15pt">
		  <fo:table-cell color="white"><fo:block> . </fo:block> </fo:table-cell>
			...
			<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="center"> <fo:block> <xsl:value-of select="ciso"/> </fo:block> </fo:table-cell>
  		<fo:table-cell margin-left="0.5mm" margin-right="0.5mm" text-align="center"> <fo:block> <xsl:value-of select="cee"/> </fo:block> </fo:table-cell>
		</fo:table-row>
	</xsl:template>
