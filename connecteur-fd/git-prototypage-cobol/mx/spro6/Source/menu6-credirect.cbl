      *{Bench}prg-comment
      * menu6-credirect.cbl
      * menu6-credirect.cbl is generated from W:\mx\spro6\menu6-credirect.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. menu6-credirect.
       AUTHOR. mistral.
       DATE-WRITTEN. mercredi 4 novembre 2020 19:31:32.
       REMARKS.
      *{Bench}end
      ...
      * display screen
              DISPLAY Standard GRAPHICAL WINDOW
                 ...
                 TITLE "PROTOTYPE EQUIPE 6", TITLE-BAR, USER-GRAY, 
                 USER-WHITE, NO WRAP, 
      ...
      *
       Screen1-Pb-art-Link.
           call "../../mx/o6/art-c.acu"
               using zone-palm lk-art-c
           cancel "../../mx/o6/art-c.acu"
           .
      *
       Screen1-Pb-mar-Link.                                                "
           call   "../../mx/o6/mar.acu" 
           cancel "../../mx/o6/mar.acu"
           .
      *
       Screen1-Pb-hiv-Link.
           call "../../mx/o6/hiv-c-credirect.acu"
               using zone-palm lk-hiv-c
           cancel "../../mx/o6/hiv-c-credirect.acu" 
           .
      *
       Screen1-Pb-sbd-Link.
           call "../../mx/o6/sbd-c.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o6/sbd-c.acu" 
           .
       Screen1-Pb-sbdo-Link.
           ...
           .
       Screen1-Pb-mtf-Link.
           call "../../mx/o6/mtf-credirect.acu" 
           cancel "../../mx/o6/mtf-credirect.acu"
           .
      *
       Screen1-Bef-Create.
      ...
      *
       Screen1-Pb-testlayout-Link.
           call "../../mx/o6/test-layout.acu" 
           cancel "../../mx/o6/test-layout.acu"
           .
      *
      ...
      *
       Screen1-Pb-sbdm-Link.
           call "../../mx/o6/sbd-cm.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o6/sbd-cm.acu"
           .
      *
       Screen1-Pb-2-Link.
           call "../../mx/o6/hivFZS.acu" using zone-palm lk-hiv-c
           cancel "../../mx/o6/hivFZS.acu"
           .
