      *{Bench}prg-comment
      * menu4-credirect.cbl
      * menu4-credirect.cbl is generated from W:\mx\spro4\menu4-credirect.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. menu4-credirect.
       AUTHOR. mistral.
       DATE-WRITTEN. mercredi 4 novembre 2020 19:38:15.
       REMARKS. 
      *{Bench}end
      ...
      * display screen
              DISPLAY Standard GRAPHICAL WINDOW
                 ...
                 TITLE "PROTOTYPE EQUIPE 4", TITLE-BAR, USER-GRAY, 
                 USER-WHITE, NO WRAP, 
      ...
      *
       Screen1-Pb-art-Link.
           call "../../mx/o4/art-c.acu"
               using zone-palm lk-art-c
           cancel "../../mx/o4/art-c.acu"
           .
      *
       Screen1-Pb-mar-Link.                                                "
           call   "../../mx/o4/mar.acu" 
           cancel "../../mx/o4/mar.acu"
           .
      *
       Screen1-Pb-hiv-Link.
           call "../../mx/o4/hiv-c-credirect.acu"
               using zone-palm lk-hiv-c
           cancel "../../mx/o4/hiv-c-credirect.acu" 
           .
      *
       Screen1-Pb-sbd-Link.
           call "../../mx/o4/sbd-c.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o4/sbd-c.acu" 
           .
       Screen1-Pb-sbdo-Link.
           ...
           .
       Screen1-Pb-mtf-Link.
           call "../../mx/o4/mtf-credirect.acu" 
           cancel "../../mx/o4/mtf-credirect.acu"
           .
      *
       Screen1-Bef-Create.
      ...
      *
       Screen1-Pb-testlayout-Link.
           call "../../mx/o4/test-layout.acu" 
           cancel "../../mx/o4/test-layout.acu"
           .
      *
      ...
      *
       Screen1-Pb-sbdm-Link.
           call "../../mx/o4/sbd-cm.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o4/sbd-cm.acu"
           .
      *
       Screen1-Pb-2-Link.
           call "../../mx/o4/hivFZS.acu" using zone-palm lk-hiv-c
           cancel "../../mx/o4/hivFZS.acu"
           .
