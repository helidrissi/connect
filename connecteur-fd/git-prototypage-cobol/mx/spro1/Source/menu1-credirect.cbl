      *{Bench}prg-comment
      * menu1-credirect.cbl
      * menu1-credirect.cbl is generated from W:\mx\spro1\menu1-credirect.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. menu1-credirect.
       AUTHOR. kobalt.
       DATE-WRITTEN. lundi 18 janvier 2021 10:55:32.
       REMARKS. 
      *{Bench}end
      ...
      * display screen
              DISPLAY Standard GRAPHICAL WINDOW
                 ...
                 TITLE "PROTOTYPE EQUIPE 1", TITLE-BAR, USER-GRAY, 
                 USER-WHITE, NO WRAP, 
      ...
      *
       Screen1-Pb-art-Link.
           call "../../mx/o1/art-c.acu"
               using zone-palm lk-art-c
           cancel "../../mx/o1/art-c.acu"
           .
      *
       Screen1-Pb-mar-Link.                                                "
           call   "../../mx/o1/mar-credirect.acu" 
           cancel "../../mx/o1/mar-credirect.acu"
           .
      *
       Screen1-Pb-hiv-Link.
           call "../../mx/o1/hiv-c-credirect.acu"
               using zone-palm lk-hiv-c
           cancel "../../mx/o1/hiv-c-credirect.acu" 
           .
      *
       Screen1-Pb-sbd-Link.
           call "../../mx/o1/sbd-c.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o1/sbd-c.acu" 
           .
       Screen1-Pb-sbdo-Link.
           ...
           .
       Screen1-Pb-mtf-Link.
           call "../../mx/o1/mtf-credirect.acu" 
           cancel "../../mx/o1/mtf-credirect.acu"
           .
      *
       Screen1-Bef-Create.
      ...
      *
       Screen1-Pb-testlayout-Link.
           call "../../mx/o1/test-layout.acu" 
           cancel "../../mx/o1/test-layout.acu"
           .
      *
      ...
      *
       Screen1-Pb-sbdm-Link.
           call "../../mx/o1/sbd-cm.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o1/sbd-cm.acu"
           .
      *
       Screen1-Pb-2-Link.
           call "../../mx/o1/hivFZS.acu" using zone-palm lk-hiv-c
           cancel "../../mx/o1/hivFZS.acu"
           .
