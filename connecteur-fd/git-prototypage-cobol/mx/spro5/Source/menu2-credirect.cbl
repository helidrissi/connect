      *{Bench}prg-comment
      * menu2-credirect.cbl
      * menu2-credirect.cbl is generated from W:\mx\spro2\menu2-credirect.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. menu2-credirect.
       AUTHOR. mistral.
       DATE-WRITTEN. mercredi 4 novembre 2020 18:54:12.
       REMARKS. 
      *{Bench}end
      ...
      *
       Screen1-Pb-art-Link.
           call "../../mx/o2/art-c.acu"
               using zone-palm lk-art-c
           cancel "../../mx/o2/art-c.acu"
           .
      *
       Screen1-Pb-mar-Link.                                                "
           call   "../../mx/o2/mar.acu" 
           cancel "../../mx/o2/mar.acu"
           .
      *
       Screen1-Pb-hiv-Link.
           call "../../mx/o2/hiv-c-credirect.acu"
               using zone-palm lk-hiv-c
           cancel "../../mx/o2/hiv-c-credirect.acu" 
           .
      *
       Screen1-Pb-sbd-Link.
           call "../../mx/o2/sbd-c.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o2/sbd-c.acu" 
           .
       Screen1-Pb-sbdo-Link.
           ...
           .
       Screen1-Pb-mtf-Link.
           call "../../mx/o2/mtf-credirect.acu" 
           cancel "../../mx/o2/mtf-credirect.acu"
           .
      *
       Screen1-Bef-Create.
      ...
      *
       Screen1-Pb-testlayout-Link.
           call "../../mx/o2/test-layout.acu" 
           cancel "../../mx/o2/test-layout.acu"
           .
      *
      ...
      *
       Screen1-Pb-sbdm-Link.
           call "../../mx/o2/sbd-cm.acu" using zone-palm lk-sbd-c
           cancel "../../mx/o2/sbd-cm.acu"
           .
      *
       Screen1-Pb-2-Link.
           call "../../mx/o2/hivFZS.acu" using zone-palm lk-hiv-c
           cancel "../../mx/o2/hivFZS.acu"
           .
