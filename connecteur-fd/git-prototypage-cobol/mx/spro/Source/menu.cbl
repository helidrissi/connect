      *{Bench}prg-comment
      * menu.cbl
      * menu.cbl is generated from W:\mx\spro\menu.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. menu.
       AUTHOR. kobalt.
       DATE-WRITTEN. mardi 8 septembre 2020 11:36:31.
       REMARKS. 
      *{Bench}end
      ...
      *{Bench}copy-screen
       01 Screen1.
           ...
           03 Screen1-Pb-art, Push-Button, 
              COL 4,43, LINE 6,85, LINES 3,23 CELLS, SIZE 26,57 CELLS, 
           ...
           03 Screen1-Pb-2, Push-Button, 
              ...
              TITLE "TEST".
           03 Screen1-Pb-arta, Push-Button, 
              COL 4,43, LINE 11,00, LINES 3,23 CELLS, SIZE 26,57 CELLS, 
              COLOR IS W-COLOR-PROTO, ID IS 8, TERMINATION-VALUE 1001, 
              TITLE "ARTICLES 2".
