      ...
      *{Bench}copy-screen
      ...
      -       "", "R", "C", "C", "L", "L", "L", "C", "R", "L", "U", "C"
           ...
           03 Screen1-La-niaaa, Label, 
              ...
              LABEL-OFFSET 0, 
              TITLE "Période en cours", TRANSPARENT.
      ...
      * Screen1-Mn-Main
       ...
       Acu-Screen1-Mn-Main.
           ...
           END-IF
           CALL "W$MENU" USING WMENU-ADD, Menu-Handle, 0, 0, "Entité", 
              1000
...
150519
      ...
      *       Calcul signe % marge / signes qté prix et marge
           ...
           END-IF
150519
150519*     ADD 1000 PMB-LIG GIVING TMA-TRI | clé tri / marge
150519     ADD 1000 MAR-TRI GIVING TMA-TRI | clé tri / marge
100913
090415
           IF CHC-MHIV <> 0 THEN
...
120819     COPY "../../mistral/copy/Mis-Patienter-Debut-Centre.cbl".
      ...
      *    Récupère les derniers paramètres sauvegardés
           PERFORM Assign-INT
           ...
           CALL   "trtselect.acu" USING ZONE-PALM LK-INT
           CANCEL "trtselect.acu"
      *--- Petite "bidouille": si module CNH  PRIM c'est la référence fournisseur et non le code article qui est mis dans l'export csv !! (Etat Mémorisé contenant le mot PRIM dans le titre)
           MOVE ZERO TO W-PRIM
...
030212
           ...
           AND AOC-INT = 0
           AND ADI-INT = 0 THEN
      *       Ancienne sélection -> autorise tout
              MOVE 1 TO AOR-INT 
                        AAD-INT 
                        AOC-INT 
                        ADI-INT
