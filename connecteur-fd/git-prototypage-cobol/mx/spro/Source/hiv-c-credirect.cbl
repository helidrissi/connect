      *{Bench}prg-comment
      * hiv-c-credirect.cbl
      * hiv-c-credirect.cbl is generated from W:\mx\spro\hiv-c-credirect.Psf
      *{Bench}end
       IDENTIFICATION              DIVISION.
      *{Bench}prgid
       PROGRAM-ID. hiv-c-credirect.
       AUTHOR. kobalt.
       DATE-WRITTEN. mardi 8 septembre 2020 11:34:52.
       REMARKS. 
      *{Bench}end
      ...
      *{Bench}copy-screen
      ...
      -       "", "R", "C", "C", "L", "L", "L", "C", "R", "L", "U", "C"
           ...
           03 Screen1-Ef-DATE1, Entry-Field, 
              COL 51,00, LINE 13,77, LINES 1,85 CELLS, 
              SIZE 12,14 CELLS, 
           ...
           03 Screen1-Ef-DATE2, Entry-Field, 
              COL 51,00, LINE 16,38, LINES 1,85 CELLS, 
              SIZE 12,14 CELLS, 
           ...
           03 Screen1-Rb-MAR2, Radio-Button, 
              COL 125,14, LINE 23,77, LINES 1,23 CELLS, 
              SIZE 22,57 CELLS, 
              COLOR IS 513, ENABLED 0, FONT IS Calibri12, GROUP 7, 
           ...
           03 Screen1-Rb-RET1, Radio-Button, 
              COL 154,29, LINE 22,15, LINES 1,23 CELLS, 
              SIZE 25,71 CELLS, 
              COLOR IS 513, FONT IS Calibri12, GROUP 10, GROUP-VALUE 1, 
              ID IS 49, 
              TITLE "Sans Rétrocessions", VALUE RET-INT, VISIBLE 0.
           03 Screen1-Rb-RET2, Radio-Button, 
              COL 154,29, LINE 23,77, LINES 1,23 CELLS, 
              SIZE 25,71 CELLS, 
              COLOR IS 513, FONT IS Calibri12, GROUP 10, GROUP-VALUE 2, 
              ID IS 50, 
              TITLE "Avec Rétrocessions", VALUE RET-INT, VISIBLE 0.
           03 Screen1-Rb-RET3, Radio-Button, 
              COL 154,29, LINE 25,38, LINES 1,23 CELLS, 
              SIZE 25,71 CELLS, 
              COLOR IS 513, FONT IS Calibri12, GROUP 10, GROUP-VALUE 3, 
              ID IS 51, 
              TITLE "Rétrocessions Seules", VALUE RET-INT, VISIBLE 0.
           03 Screen1-Rb-VEN1, Radio-Button, 
              COL 125,14, LINE 10,00, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
           ...
           03 Screen1-Rb-VEN2, Radio-Button, 
              COL 125,14, LINE 11,54, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
              COLOR IS 513, ENABLED 0, FONT IS Calibri12, GROUP 4, 
           ...
           03 Screen1-Rb-TEC1, Radio-Button, 
              COL 139,29, LINE 10,00, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
           ...
           03 Screen1-Rb-TEC2, Radio-Button, 
              COL 139,29, LINE 11,54, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
              COLOR IS 513, ENABLED 0, FONT IS Calibri12, GROUP 5, 
           ...
           03 Screen1-Rb-POS1, Radio-Button, 
              COL 154,00, LINE 10,00, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
           ...
           03 Screen1-Rb-POS2, Radio-Button, 
              COL 154,00, LINE 11,54, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
              COLOR IS 513, ENABLED 0, FONT IS Calibri12, GROUP 6, 
           ...
           03 Screen1-Rb-DEP2, Radio-Button, 
              COL 168,00, LINE 11,54, LINES 1,23 CELLS, 
              SIZE 11,71 CELLS, 
              COLOR IS 513, ENABLED 0, FONT IS Calibri12, GROUP 9, 
           ...
           03 Screen1-Pb-ReduireS, Push-Button, 
              COL 166,57, LINE 4,85, LINES 3,00 CELLS, 
              SIZE 13,71 CELLS, 
           ...
           03 Screen1-La-DATE1, Label, 
              COL 47,29, LINE 13,77, LINES 1,46 CELLS, SIZE 2,86 CELLS, 
              COLOR IS 513, FONT IS Calibri12, ID IS 16, LEFT, 
              LABEL-OFFSET 0, 
              TITLE "Du", TRANSPARENT, VISIBLE 0.
           03 Screen1-La-DATE2, Label, 
              COL 47,29, LINE 16,38, LINES 1,46 CELLS, SIZE 2,71 CELLS, 
              COLOR IS 513, FONT IS Calibri12, ID IS 19, LEFT, 
              LABEL-OFFSET 0, 
              TITLE "Au", TRANSPARENT, VISIBLE 0.
           03 Screen1-La-TYPE, Label, 
              COL 124,86, LINE 25,77, LINES 1,38 CELLS, 
              SIZE 5,43 CELLS, 
              COLOR IS 1, FONT IS Calibri11, ID IS 21, RIGHT, 
              LABEL-OFFSET 0, 
           ...
           03 Screen1-Pb-ReduireA, Push-Button, 
              COL 166,57, LINE 32,85, LINES 3,00 CELLS, 
              SIZE 13,71 CELLS, 
              COLOR IS 513, BACKGROUND-RGB H#00FFFFFF, 
           ...
           03 Screen1-La-ART, Label, 
              COL 55,71, LINE 20,38, LINES 1,08 CELLS, SIZE 1,43 CELLS, 
              COLOR IS 525, FONT IS Small-Font, ID IS 107, CENTER, 
              LABEL-OFFSET 0, 
              TITLE "*", VISIBLE 0.
           03 Screen1-La-VEN, Label, 
              COL 133,71, LINE 8,77, LINES 1,08 CELLS, SIZE 1,71 CELLS, 
              COLOR IS 525, FONT IS Small-Font, ID IS 108, CENTER, 
              LABEL-OFFSET 0, 
              TITLE "*", VISIBLE 0.
           03 Screen1-La-POS, Label, 
              COL 164,14, LINE 8,38, LINES 0,85 CELLS, SIZE 1,29 CELLS, 
              COLOR IS 525, FONT IS Calibri10B, ID IS 109, CENTER, 
              LABEL-OFFSET 0, 
              TITLE "*", VISIBLE 0.
           03 Screen1-La-CLI, Label, 
              COL 10,00, LINE 20,23, LINES 1,08 CELLS, SIZE 1,43 CELLS, 
              COLOR IS 525, FONT IS Small-Font, ID IS 106, CENTER, 
              LABEL-OFFSET 0, 
              TITLE "*", VISIBLE 0.
           03 Screen1-Fr-Tot, Frame, 
              COL 60,00, LINE 4,69, LINES 3,15 CELLS, SIZE 61,57 CELLS, 
              COLOR IS 297, FILL-COLOR 9, FILL-PERCENT 100, ID IS 112, 
              VISIBLE 0, BACKGROUND-LOW.
           03 Screen1-La-TOT, Label, 
              COL 64,71, LINE 5,54, LINES 2,00 CELLS, SIZE 12,57 CELLS, 
              COLOR IS 33072, FONT IS Calibri14B, ID IS 92, CENTER, 
              LABEL-OFFSET 0, 
              TITLE "Totaux : Qté=", VISIBLE 0.
           03 Screen1-Ef-TOT-QTE, Entry-Field, 
              COL 77,29, LINE 5,54, LINES 2,00 CELLS, SIZE 11,71 CELLS, 
              NO-BOX, COLOR IS 33072, FONT IS Calibri14B, ID IS 95, 
              LEFT, VALUE TOT-QTE, VISIBLE 0.
           03 Screen1-La-HT, Label, 
              COL 93,43, LINE 5,54, LINES 2,00 CELLS, SIZE 4,43 CELLS, 
              COLOR IS 33072, FONT IS Calibri14B, ID IS 94, CENTER, 
              LABEL-OFFSET 0, 
              TITLE "HT=", VISIBLE 0.
           03 Screen1-Ef-TOT-HT, Entry-Field, 
              COL 97,86, LINE 5,54, LINES 2,00 CELLS, SIZE 17,29 CELLS, 
           ...
           03 Screen1-Rb-DFA0, Radio-Button, 
              COL 46,86, LINE 10,00, LINES 1,23 CELLS, 
              SIZE 13,29 CELLS, 
           ...
           03 Screen1-Rb-DFA1, Radio-Button, 
              COL 46,86, LINE 11,54, LINES 1,23 CELLS, 
              SIZE 14,57 CELLS, 
           ...
           03 Screen1-Cb-AVO, Check-Box, 
              COL 47,00, LINE 32,54, LINES 1,69 CELLS, 
              SIZE 36,57 CELLS, 
           ...
           03 Screen1-La-MSGNB, Label, 
              COL 123,86, LINE 5,69, LINES 1,46 CELLS, 
              SIZE 29,29 CELLS, 
