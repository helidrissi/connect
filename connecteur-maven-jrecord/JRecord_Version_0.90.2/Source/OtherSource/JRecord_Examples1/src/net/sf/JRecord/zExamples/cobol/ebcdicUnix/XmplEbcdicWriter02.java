 ...
 * Using a ByteTextWriter and a LineWriterWrapper
 * 
 * @author Bruce Martin
 *
 */

public class XmplEbcdicWriter02 {

	static String charset = "cp037";
	static String cobolCopyBook = "        01  A-Line     Pic x(40).";
	
	public static void main(String[] args)  {
		String fileName =  TstConstants.TEMP_DIRECTORY + "cp037FixedWidth_02.txt";
		try {
			...
			LineWriterWrapper w = new LineWriterWrapper(new ByteTextWriter(eolBytes));
	...
	private static ExternalRecord getCobolLayout(int cobolDialect, String cobolCopybook) throws RecordException, IOException {
		...
		return loader.loadCopyBook(
				bs, "ZZ-TTT4", CopybookLoader.SPLIT_NONE, 0, charset, Cb2xmlConstants.USE_STANDARD_COLUMNS, cobolDialect, 0, new TextLog());
	}
}
