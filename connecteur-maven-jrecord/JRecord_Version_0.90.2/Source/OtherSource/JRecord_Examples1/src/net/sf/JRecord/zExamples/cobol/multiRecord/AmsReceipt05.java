 ...
 *  <li>Using the RecordDetail method getGroupField to get a field definition.
...
public class AmsReceipt05 {
    ...
    private AmsReceipt05() throws Exception {
    ...
    private void readFile() throws IOException, RecordException {
    	...
    	AbstractLine l;
    	String id;
    	RecordDetail stdRec = schema.getRecord(schema.getRecordIndex("STDR-DETAIL-RECORD"));
    	RecordDetail rhRec  = schema.getRecord(schema.getRecordIndex("STDR-RH"));
      	// Note:
    	...
    	//
    	IFieldDetail recordType = stdRec.getGroupField("STDR-DETAIL-RECORD", "XXX", "STDR-RECORD-TYPE");

  
    	IFieldDetail day        = stdRec.getGroupField("STDR-DETAIL-RECORD", "STDR-FH-CRD-DD");
    	IFieldDetail month      = stdRec.getGroupField("XXX", "STDR-FH-CRD-DD");
    	IFieldDetail century    = stdRec.getGroupField("STDR-FH-CRD-DD");
    	IFieldDetail year       = stdRec.getGroupField("STDR-FH-CRD-DD");
    	
    	IFieldDetail brand           = rhRec.getGroupField("STDR-RH", "BRAND-ID-RH");
    	IFieldDetail orderNumber     = rhRec.getGroupField("ORDER-NO-RH");
    	IFieldDetail receiptLocation = rhRec.getGroupField("RECEIPT-LOCN-RH");
    	IFieldDetail receiptNumber   = rhRec.getGroupField("RECEIPT-NO-RH");
